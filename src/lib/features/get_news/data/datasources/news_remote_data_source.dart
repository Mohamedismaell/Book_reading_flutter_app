...
//   Future<NewsModel> getNewsByCategory(NewsCategoryParams params) async {
//     // print(
...
//         : EndPoints.formatCategoryQuery(EndPoints.defaultCategory);
//     // print('🔍 Query: $categoryQuery');
//     final newsCategoryRes = await api.get(
//       EndPoints.news,
//       queryParameters: {'token': EndPoints.token, 'q': categoryQuery},
//     );
